...
from src.data_loader.ScaffoldMemory import ScaffoldMemory


class ScaffoldFilter(ScaffoldMemory):

    def __init__(self, nbmax=50, minscore=0.5, generic=False, outputmode="linear"):
...
class CompoundSimilarity(ScaffoldFilter):
    ...
    def __init__(self, nbmax=50, minscore=0.4, minsimilarity=0.4, radius=2, useFeatures=False, bits=1024, outputmode="linear"):
        super().__init__(nbmax=nbmax, minscore=minscore, generic=False, outputmode=outputmode)
...
class ScaffoldSimilarity(CompoundSimilarity):
    ...
    def __init__(self, nbmax=50, minscore=0.5, minsimilarity=0.6, outputmode="linear"):
